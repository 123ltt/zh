  ...
  <basic-container v-loading="loading">
        ...
        <el-row :gutter="30">
          <el-col :span="8">
            <el-form-item label="业务类型">
              <el-input :value="detailData.outputType.desc" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="8">
          ...
          <el-col :span="8">
            <el-form-item label="出库单号">
              <el-input :value="detailData.outputCode" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="出库日期">
              <el-input :value="detailData.outputDate" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="8">
            <el-form-item label="出库数量">
              <el-input :value="detailData.outputQty" disabled />
            </el-form-item>
          </el-col>
        </el-row>
      </el-form>
    ...
    <el-card>
      ...
      <el-table :data="recordData" max-height="400" stripe style="width:100%" size="mini" border class="g-table">
        ...
        <el-table-column prop="outputQty" label="出库数量" align="center" min-width="100" />
      </el-table>
    </el-card>
  </basic-container>
</template>
...
<script>
import { getDetail } from '@/api/inWarehouse/outWarehouse.js'
export default {
