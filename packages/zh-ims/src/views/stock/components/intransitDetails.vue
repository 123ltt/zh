...
<script>
import { getIntransitDetail, getType } from '@/api/stock/view.js'
import { deepClone } from '@/util/util'

export default {
  name: 'IntransitDetails',
  props: {
    id: String
  },
  data() {
  ...
  methods: {
    ...
    fetch({ current, size }, params) {
      return getIntransitDetail(current, size, params).then(res => {
        return {
