<template>
  <basic-container>
    <g-table ref="table" :headers="headers" row-key="id" :fetch="fetch" :page-size="20" class="myTable">
      ...
      <el-table-column slot="index" label="序号" type="index" width="50px" :index="setIndex" />
...
::v-deep .el-input__inner{
 ...
 .myTable ::v-deep .el-table thead tr th{
