...
export const routes = [
  ...
  },
  {
    ...
    path: '/permiss/application',
    component: () => import(/* webpackChunkName: "permiss" */ '@/views/_application.vue')
  },
  {
  ...
  {
    name: 'PermissResourceList',
    path: '/permiss/resourceList',
    component: () => import(/* webpackChunkName: "permiss" */ '@/views/_resourceList.vue')
  }
].map(item => {
...
export const apiPrefix = JSON.parse('[["$auth","cams-auth"],["$ams","cams"]]')
