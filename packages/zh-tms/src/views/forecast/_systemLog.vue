          ...
          <el-row>
            <el-col :span="7">
              <el-form-item label="业务单号：" prop="referenceNumber">
                <el-input v-model.trim="formData.referenceNumber" placeholder="请输入" clearable class="w-85" />
              </el-form-item>
            </el-col>
        ...
        <template v-slot="{row}">
          <g-list-group label-width="30px" align="left">
            ...
            <g-list-group-item label="状态">
              <span :class="row.status?'text-danger':''" style="text-align:left">{{ ['成功','失败'][row.status] }}
              </span>
            </g-list-group-item>
          </g-list-group>
        </template>
