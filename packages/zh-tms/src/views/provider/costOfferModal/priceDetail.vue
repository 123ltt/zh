...
export default {
  ...
  data() {
    return {
      ...
      valueList: [],
      groupList: [
        { name: '费用项名称', prop: 'itemNameRe' },
        { name: '价格版本', prop: 'channelNumber' },
        { name: '价格模板', prop: 'templateTypeRe' },
        { name: '币种', prop: 'currency' },
        { name: '生效日期', prop: 'startDate' },
        { name: '失效日期', prop: 'endDate' }
      ],
      loading: false,
      tableList: [],
      tableData: [],
