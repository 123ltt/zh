    ...
    >
      ...
      <template v-for="(item,index) in priceLogHeaders">
        ...
        <el-table-column v-if="item.slotName==='firstCost'" :key="index" :label="item.label" align="center">
          <template slot-scope="props">
            <g-link v-if="props.row.firstCost" color="primary" @click="detailBtn(props.row, item.value)">
              {{ props.row.firstCost }}
            </g-link>
          </template>
        </el-table-column>
        ...
        <el-table-column v-if="item.slotName==='tailCost'" :key="index" :label="item.label" align="center">
          <template slot-scope="props">
            <g-link v-if="props.row.tailCost" color="primary" @click="detailBtn(props.row, item.value)">
              {{ props.row.tailCost }}
            </g-link>
          </template>
        </el-table-column>
        ...
        <el-table-column v-if="item.slotName==='fullCost'" :key="index" :label="item.label" align="center">
          <template slot-scope="props">
            <g-link v-if="props.row.fullCost" color="primary" @click="detailBtn(props.row, item.value)">
              {{ props.row.fullCost }}
            </g-link>
