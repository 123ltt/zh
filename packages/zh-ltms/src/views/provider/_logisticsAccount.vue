...
import { getAccountList, platformAccountList, deleted, getCodeUrl } from '@/api/logisticsAccount'// 物流账号下拉列表接口+物流账号分页列表接口+删除接口+code跳转接口
import addEdit from './logisticsAccountModal/addEdit' // 导入新增页面组件
import authorization from './logisticsAccountModal/authorization' // 导入授权页面组件
export default {
