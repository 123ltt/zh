...
// 可发仓库
export const useWarehouse = (countryCodes) =>
...
// 下载通用邮编模板
export const downloadUsualTemplate = (type, lId) =>
  request.$ltms_provider({
...
// 邮编导出接口
export const exportPostcodeExcel = (lId) =>
  request.$ltms_provider({
...
// 价格类型导出
export const exportPriceTypeExcel = (lId, templateType) =>
  request.$ltms_provider({
