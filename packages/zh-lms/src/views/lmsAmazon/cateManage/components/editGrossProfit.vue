<template>
  <basic-container style="min-width: 0">
    <el-form ref="dialogForm" :model="form" size="mini" label-width="110px" :rules="rules">
      ...
      <el-form-item label="类目树" prop="browsePathByName">
        {{ form.browsePathByName }}
      </el-form-item>
...
import { updateGrossProfit } from '@/api/amazon/category'
    ...
    submitDialog(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          ...
          updateGrossProfit({ id, grossProfit }).then((res) => {
