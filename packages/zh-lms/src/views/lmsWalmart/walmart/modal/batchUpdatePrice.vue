<template>
  <el-form ref="form" :model="form" size="mini" label-width="155px" class="form-col" :rules="rules" @submit.native.prevent>
    <el-form-item label="所有子SKU价格调整为：" prop="profitRate" class="mb-5">
