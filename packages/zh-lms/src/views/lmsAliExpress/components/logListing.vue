...
export default {
  ...
  methods: {
    getMapLog(value) {
      return getMapLog({ key: value }, 'aliExpress').then(res => res.data)
    },
    // 创建人列表
    getUserList(query) {
