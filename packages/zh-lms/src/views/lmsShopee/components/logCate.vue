          ...
          <el-row :gutter="10">
            ...
            <el-col :span="6">
              <el-form-item label="操作人" prop="createUser">
                <g-select v-model="form.createUser" :items="userList" key-field="id" label-field="nameJobNumber" value-field="name" class="w-100" />
              </el-form-item>
            </el-col>
            <el-col :span="6">
              <el-form-item>
...
<script>
import { getCategoryLog } from '@/api/shopee/log'
