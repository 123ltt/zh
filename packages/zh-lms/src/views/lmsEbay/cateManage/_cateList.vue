          ...
          <el-row :gutter="10">
            ...
            <el-col :span="5">
              <el-form-item label="平台类目名称" prop="platCategoryName">
                <el-input v-model="form.platCategoryName" placeholder="请输入" clearable />
              </el-form-item>
            </el-col>
            <el-col :span="5">
              <el-form-item label="平台类目ID" prop="platCategoryId">
                <el-input v-model="form.platCategoryId" placeholder="请输入" clearable />
              </el-form-item>
            </el-col>
            <el-col :span="9">
              <el-form-item>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        {
          label: '类目树',
          prop: 'platCategoryPath'
        },
        {
          label: '平台类目名称',
          prop: 'platCategoryName'
        },
        {
          label: '平台类目ID',
          prop: 'platCategoryId'
