          ...
          <el-row :gutter="10" class="searchBox">
            <el-col :span="9">
              <el-form-item prop="productSkuList" label="产品编码">
                <el-input v-model.trim="submit.productSkuList" style="width:80%" clearable placeholder="请填写" />
              </el-form-item>
            </el-col>
            <el-col :span="9">
              <el-form-item prop="productName" label="产品名称">
                <el-input v-model.trim="submit.productName" clearable placeholder="请填写" style="width:80%" />
              </el-form-item>
            </el-col>
            <el-col :span="9">
...
<script>
import { getList, remove, updateStatue } from '@/api/basicManagement/cycle.js'
import { dictionary } from '@/api/commonApi.js'
import cycleAdd from './components/cycleAdd.vue'
...
export default {
  ...
  methods: {
    ...
    addBtn(val) {
      ...
      this.$modal({
        title: (this.isAdd ? '新增供货周期' : '编辑供货周期'),
        component: cycleAdd,
        data: {
          isAdd: this.isAdd,
