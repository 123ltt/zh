    ...
    <el-card class="cardBox">
      ...
      <el-form class="no-message" size="mini" label-width="120px">
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="全部库存">
              <el-input :value="detail.allInv" disabled>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="本地在途库存">
              <el-input :value="detail.localTransitInv" disabled>
                <template slot="prepend">大于等于</template>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="本地采购中库存">
              <el-input :value="detail.localProcurementInv" disabled>
                <template slot="prepend">大于等于</template>
              </el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="本地备用库存">
              <el-input :value="detail.localReserveInv" disabled>
                <template slot="prepend">大于等于</template>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="本地可用库存">
              <el-input :value="detail.localAvailableInv" disabled>
                <template slot="prepend">大于等于</template>
              </el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="海外在途库存">
              <el-input :value="detail.overseaTransitInv" disabled>
                <template slot="prepend">大于等于</template>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="海外采购中库存">
              <el-input :value="detail.overseaProcurementInv" disabled>
                <template slot="prepend">大于等于</template>
              </el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="10">
          <el-col :span="12">
            <el-form-item label="海外备用库存">
              <el-input :value="detail.overseaReserveInv" disabled>
                <template slot="prepend">大于等于</template>
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="海外可用库存">
              <el-input :value="detail.overseaAvailableInv" disabled>
                <template slot="prepend">大于等于</template>
              </el-input>
            </el-form-item>
          </el-col>
...
import { getDetail } from '@/api/basicManagement/inventoryRules.js'
export default {
  name: 'InventoryRulesDetail',
  props: {
    detailData: Object
  },
  data() {
