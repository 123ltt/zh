        ...
        <el-row :gutter="10">
          ...
          <el-col :span="12">
            <el-form-item label="开发员">
              <el-input :value="detail.developerName" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="产品对接员">
              <el-input :value="detail.productDirectorName" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="本地仓采购">
              <el-input :value="detail.localPurchaserName" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="海外仓采购">
              <el-input :value="detail.overseaPurchaserName" disabled />
            </el-form-item>
          </el-col>
          <el-col :span="12">
...
import { getDetail } from '@/api/basicManagement/distribution.js'
export default {
