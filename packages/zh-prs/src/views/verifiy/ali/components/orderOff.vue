...
export default {
      ...
      headers: [
        ...
        { label: '平台订单号', prop: 'platformOrderCode' },
        {
          ...
          list: [
            ...
            { label: '平台退款额', prop: 'platformRefund' }
          ]
        },
        {
          slot: true,
  ...
  methods: {
    ...
    showDetail(row) {
      this.$newTab({
        path: '/ali/bill/orderOff/detail',
        title: '订单核销详情',
        component: detail,
        data: {
          info: { id: row.id, isVerify: 0, platformCode: 'AI' }
        },
        clearCache: true
      })
    },
    ...
    fetch({ current, size }, params) {
      Object.assign(params, { platformCode: 'AI', verifyBillId: this.verifyBillId })
